...
const ExamDetail = () => {
  ...
  useEffect(() => {
    if (examForm.eligibleBranches && examForm.eligibleBranches.length > 0) {
      getDomains(examForm.eligibleBranches)
        .then(({ data }) => {
      ...
      setExamForm((prev) => ({ ...prev, eligibleDomains: [] }));
    }
  }, [examForm.eligibleBranches]);
          ...
          <div className="card border-primary-200">
            ...
            <div className="card-body space-y-4">
              ...
              <div>
                ...
                {(!examForm.eligibleBranches || examForm.eligibleBranches.length === 0) ? (
